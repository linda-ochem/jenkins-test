...
function DropdownClassic() {
  const options = [
    {
      id: 0,
      transactionType: "Virtual Card Transactions",
    },
    {
      id: 1,
      transactionType: "Physical Card Transactions",
    },
  ];
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className="btn justify-between min-w-44 bg-slate-200  text-blue-900 hover:text-blue-900"
