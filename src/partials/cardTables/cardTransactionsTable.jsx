...
import SingleCardTransactionPanel from "./SingleCardTransactionPanel";
import PaginationDisplay from "../../components/PaginationDisplay";

function CardsTransactionsTable({
  TransactionList,
  goToPage,
  paginationMeta,
  loading,
            ...
            <table className="table-auto w-full">
              ...
              <thead className="text-xs font-semibold uppercase text-slate-500 border-t border-b border-slate-200">
                <tr>
                  ...
                  <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    <div className="font-semibold text-right">Fee</div>
                  </th>
                  <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                ...
                {TransactionList?.map((transaction, index) => {
                  return (
                    ...
                    >
                      ...
                      {/* Currency*/}
                      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                        <div className="text-left">{transaction.currency}</div>
                      </td>
                      {/* Amount */}
                      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
