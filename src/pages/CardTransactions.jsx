...
function CardTransactions(props) {
  ...
  const [filterParams, setFilterParams] = useState({
    ...
    // endDate: "",
    // search: "",
    // interswitchTransactionReference: null,
  });
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await sendGetRequest2(
          `/admin/virtual-card-transactions?page=${pageNumber}&limit=50${
                    ...
                    <div className="m-3">
                      ...
                      <label className="flex items-center w-full">
                        <input
                          ...
                          value={filterParams.interswitchTransactionReference}
                          type="checkbox"
                          className="form-checkbox w-[2rem] h-[2rem]"
                          onChange={handleFilterChange}
                        />
                        <span className="text-sm ml-2">GGC Transactions</span>
                      </label>
                      {/* End */}
                    </div>
                  </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(CardTransactions);
