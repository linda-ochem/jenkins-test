...
import { approveKyc, disApproveKyc, getPendingKYC } from "../actions";
import empty from "../images/empty.svg";
import { EditOutlined } from "@ant-design/icons";
import { UserDetails } from "./UserDetails";

function PendingKYC(props) {
        ...
        try {
          const res =
            status === "APPROVE"
              ...
              : await disApproveKyc(userId, Reason);
                ...
                <form>
                  <div className="space-y-3">
                    <div>
                      <Image
                        style={{ maxWidth: "100%" }}
                        src={selectedUser.KycPictureURL}
                        fallback={empty}
                      />
                    </div>
                  </div>
...
export default connect(mapStateToProps)(PendingKYC);
