...
function SingleSafeLockTransactions(props) {
  ...
  const fetchTransactions = async () => {
    try {
      (async () => {
        setLoading(true);
        const response1 = await getSingleSavingsTransactions(
          props?.userId,
          PageNumber
        );
...
export default SingleSafeLockTransactions;
